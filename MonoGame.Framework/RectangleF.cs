...
namespace Microsoft.Xna.Framework
{
    ...
    public struct RectangleF : IEquatable<RectangleF>
    {
        ...
        public Vector2 Size
        {
            get
            {
                return new Vector2((int)this.Width, (int)this.Height);
            }
            set
            {
                Width = value.X;
        ...
        public Vector2 Center
        {
            get
            {
                return new Vector2((int)(this.X + (this.Width / 2)), (int)(this.Y + (this.Height / 2)));
            }
        }
        ...
        /// </summary>
        /// <param name="a"><see cref="RectangleF"/> to be converted.</param>
        /// <returns><see cref="Rectangle"/> new instance.</returns>
        ...
        public static void Intersect(ref RectangleF value1, ref RectangleF value2, out RectangleF result)
        {
            ...
            {
                float right_side = MathHelper.Min(value1.X + value1.Width, value2.X + value2.Width);
                float left_side = MathHelper.Max(value1.X, value2.X);
                float top_side = MathHelper.Max(value1.Y, value2.Y);
                float bottom_side = MathHelper.Min(value1.Y + value1.Height, value2.Y + value2.Height);
        ...
        {
            float x = MathHelper.Min(value1.X, value2.X);
            float y = MathHelper.Min(value1.Y, value2.Y);
